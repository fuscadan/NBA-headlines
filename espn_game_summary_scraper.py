...
'''
    Given an ESPN game ID, scrape raw data from the game summary page and
    return an object of class 'Game(game_id)' with the following methods:
...
class Game:
    ...
    def __init__(self,game_id):
        ...
        url = game_summary_root + game_id.strip()
        ...
        current_game_tag = series_wrap_tag[0].find_all('a' , attrs={'data-gameid': game_id.strip()})[0].parent
